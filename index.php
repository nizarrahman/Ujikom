...
<body class="scrollbar">
  ...
  <header class="header-nav">
	...
	<!-- Theme Change Button -->
        ...
        <a href='login.php' class="btn-ghost">Masuk / Daftar</a>
        <!-- Nav Menu -->
        <div class="nav-menu">
          <ul class="nav-list">
    ...
    <div class="container">
      ...
      <div class="flex flex-wrap">
        ...
        <div class="home-greets">
          <h1 class="dark-mode-text my-1 block text-4xl font-bold text-dark lg:text-[40px]">Selamat datang di aplikasi laporan masyarakat Kota Cianjur</h1>
          <h3 class="dark-mode-text mb-5 text-base font-semibold text-secondary md:text-lg">(by Nizar Rahman)
          </h3>
  ...
  <section id="about" class="dark-mode py-24">
	...
	<br>
        <span class="text-subtitle block mb-6 text-base font-semibold text-secondary md:text-lg">Selamat datang di Website Pengaduan Kota Cianjur, yang dimana disediakan untuk menjebatani sekaligus memudahkan masyarakat kota khususnya untuk melayangkan aspirasi, saran, kritik, pengaduan, maupun pertanyaan kepada perangkat pemerintah kota Cianjur. Silahkan layangkan pengaduan anda untuk kota Cianjur yang lebih baik.</span>
      </div>
    </div>
  </section>
  ...
  <section id="contact" class="dark-mode pt-24 pb-28">
    <div class="container">
      <div class="title-main">
        ...
        <span class="text-subtitle block">PEMERINTAH KOTA Cianjur</span>
      </div>
      <div class="contact-data">
        <div class="w-full p-4 md:w-1/2 lg:w-1/2 xl:w-1/3">
          <a href="https://maps.app.goo.gl/bCszTEypQ5BCXW3KA" target="_blank" class="contact-icons">
            <div class="contact-card hover:border-[#33cccc] hover:text-[#33cccc]"> <img align="center" src="img/icon/location.gif" alt="phone" width="100px">
              ...
              <span class="contact-subtitle">Jl. Pamoyanan, Kec. Cianjur, Kabupaten Cianjur, Jawa Barat</span>
            </div>
          </a>
        </div>
        <div class="w-full p-4 md:w-1/2 lg:w-1/2 xl:w-1/3">
          <a href="mailto:diskominfosantik@cianjurkab.go.id" target="_blank" class="contact-icons">
            <div class="contact-card hover:border-[#33cccc] hover:text-[#33cccc]"> <img align="center" src="img/icon/email.gif" alt="phone" width="100px">
              ...
              <span class="contact-subtitle">Cianjurkab@go.id</span>
            </div>
          </a>
        </div>
        <div class="w-full p-4 md:w-1/2 lg:w-1/2 xl:w-1/3">
          <a href="https://web.cianjurkab.go.id" target="_blank" class="contact-icons">
            <div class="contact-card hover:border-[#33cccc] hover:text-[#33cccc]"> <img align="center" src="img/icon/browser.gif" alt="phone" width="100px">
              ...
              <span class="contact-subtitle">web.cianjurkab.go.id</span>
            </div>
          </a>
        </div>
        <div class="w-full p-4 md:w-1/2 lg:w-1/2 xl:w-1/3">
          <a href="#" target="_blank" class="contact-icons">
            <div class="contact-card hover:border-[#33cccc] hover:text-[#33cccc]"> <img align="center" src="img/icon/phone.gif" alt="phone" width="100px">
              ...
              <span class="contact-subtitle">(0263)261892</span>
            </div>
          </a>
        </div>
      </div>
  ...
  <footer class="bg-primary pt-16 pb-12">
    <div class="container">
      ...
      <div class="w-full border-t border-slate-400 pt-10">
        <span class="ml-4 text-sm text-icons">&#169; 2024 <span class="font-semibold">Pemerintah Kota Cianjur</span> By Nizar
          All Reserved</span>
      </div>
